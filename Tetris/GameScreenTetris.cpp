#include "GameScreenTetris.h"
#include <iostream>
#include "Texture2D.h"
#include <stdlib.h> 
#include <ctime>

GameScreenTetris::GameScreenTetris(SDL_Renderer* renderer) : GameScreen(renderer)
{
	srand(time(0));
	SetUpLevel();
}

GameScreenTetris::~GameScreenTetris()
{
	delete mPlayField;
	mPlayField = nullptr;
	delete mText;
...
void GameScreenTetris::Update(float deltaTime, SDL_Event e)
{
...
bool GameScreenTetris::SetUpLevel()
{
...
void GameScreenTetris::SetTileMap()
{
	if (mTileMap != nullptr)
	{
		delete mTileMap;
...
void GameScreenTetris::CreateTetromino()
{
...
void GameScreenTetris::UpdateTetromino(float deltaTime, SDL_Event e)
{
...
void GameScreenTetris::Randomiser()
{
	if (counter == 7)
	{
		for (int j = 0; j < 7; j++)
...
void GameScreenTetris::ShiftTetrominoes()
{
